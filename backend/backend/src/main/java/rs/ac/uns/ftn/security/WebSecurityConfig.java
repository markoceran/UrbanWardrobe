...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/product/{code}").hasAuthority("ADMIN")
                .antMatchers("/product/{code}").hasAuthority("USER")
                ...
                .antMatchers("/basket/addBasketItem").hasAuthority("USER")
                .antMatchers("/basket/removeBasketItem/{basketItemId}").hasAuthority("USER")
                .antMatchers("/basket/decreaseQuantityFromBasketItem/{basketItemId}").hasAuthority("USER")

                .antMatchers("/wishlist/addProduct").hasAuthority("USER")
                .antMatchers("/wishlist/removeProduct/{productId}").hasAuthority("USER")

                .antMatchers("/order/create").hasAuthority("USER")
                .antMatchers("/order/{code}").hasAuthority("USER")
                .antMatchers("/order/{code}").hasAuthority("COURIER")
                .antMatchers("/order/{code}").hasAuthority("WORKER")
                ...
                .antMatchers("/order/sentOrders").hasAuthority("WORKER")
                .antMatchers("/order/sentOrders").hasAuthority("COURIER")
                ...
                .antMatchers("/order/searchSentOrdersByCode").hasAuthority("WORKER")
                .antMatchers("/order/searchSentOrdersByCode").hasAuthority("COURIER")
